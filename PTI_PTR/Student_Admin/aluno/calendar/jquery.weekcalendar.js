...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
       ...
       options : {
         ...
         shortDays : ['Sun', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sat'],
         longDays : ['Sunday', 'Segunda-Feira', 'Terça-Feira', 'Quarta-Feira', 'Quinta-Feira', 'Sexta-Feira', 'Saturday']
      },
      ...
      /*
       * Remove an event based on it's i
       */
...
/*
      ...
      */
      ...
      _updateEventInCalendar : function (calEvent) {
         ...
         if (calEvent.id) {
            self.element.find(".wc-cal-event").each(function() {
               if ($(this).data("calEvent").id === calEvent.ild || $(this).hasClass("wc-new-cal-event")) {
                  $(this).remove();
                  return false;
               }
            });
